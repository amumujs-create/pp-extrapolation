...
- [`PPX_CRT_REJECTED_EXPERIMENT_KO.md`](PPX_CRT_REJECTED_EXPERIMENT_KO.md)
...
- [`PPX_PAPER_NARRATIVE_AND_EVIDENCE_REGISTRY_KO.md`](PPX_PAPER_NARRATIVE_AND_EVIDENCE_REGISTRY_KO.md) — final narrative, claim boundary, evidence registry
- [`PPX_CROSS_DOMAIN_STABILITY_COMPARISON_KO.md`](PPX_CROSS_DOMAIN_STABILITY_COMPARISON_KO.md) — cross-domain stability entry point
- [`SELECTIVE_REGRESSION_EQUAL_COVERAGE_RESULTS_KO.md`](SELECTIVE_REGRESSION_EQUAL_COVERAGE_RESULTS_KO.md)
