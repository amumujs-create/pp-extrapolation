#!/usr/bin/env python3
"""Frozen PP-X v1.0 on the Tongji BatteryLife processed cohort.

Follows protocols/TONGJI_PPX_V1_PROTOCOL.md.  Used only because CALB was
inconclusive for sample size.  The one-dimensional hull coordinate is
normalized health.  Archive SHA-256 is written before pickle parsing.
"""
...
OUT = ROOT / "results" / "tongji_ppx_v1"
MANIFEST = ROOT / "data" / "tongji_ppx" / "sha256_manifest.json"
...
def main() -> None:
    ...
    MANIFEST.write_text(json.dumps({
        "archive": "Tongji.zip",
        "source": "https://zenodo.org/records/14934405/files/Tongji.zip",
        "sha256": digest,
    ...
    write({
        ...
        "model": "PP-X v1.0 core + validation-selected residual executor",
        "dataset": "Tongji BatteryLife processed",
        "protocol": "TONGJI_PPX_V1",
        "archive_sha256": digest,
        "eligibility": audits,
        "eligible_ids": eligible,
