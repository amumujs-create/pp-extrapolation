#!/usr/bin/env python3
"""Frozen PP-X v1.0 on the CALB BatteryLife processed cohort.

Follows protocols/CALB_PPX_V1_PROTOCOL.md.  The one-dimensional hull
coordinate is normalized health, not raw ampere-hours.  Archive SHA-256
is written before pickle parsing.  Test labels are used only after
executor and hyperparameter selection on validation RMSE.
"""
...
DATA = ROOT / "data" / "calb_ppx" / "CALB.zip"
OUT = ROOT / "results" / "calb_ppx_v1"
MANIFEST = ROOT / "data" / "calb_ppx" / "sha256_manifest.json"
...
def main() -> None:
    ...
    MANIFEST.write_text(json.dumps({
        "archive": "CALB.zip",
        "source": "https://zenodo.org/records/14934405/files/CALB.zip",
        "sha256": digest,
    ...
    write({
        ...
        "model": "PP-X v1.0 core + validation-selected residual executor",
        "dataset": "CALB BatteryLife processed",
        "protocol": "CALB_PPX_V1",
        "archive_sha256": digest,
        "eligibility": audits,
        "eligible_ids": eligible,
